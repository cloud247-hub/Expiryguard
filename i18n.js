(() => {
  ...
  const EN = {
    ...
    "E-postvarsler": "Email notifications",
    "Varslingslogg": "Notification log",
    "En egen varslingskanal ved siden av Teams. Oppsett og mottakere gjelder bare valgt kunde.": "An independent notification channel alongside Teams. Settings and recipients apply only to the selected customer.",
    "Aktiver e-postvarsler": "Enable email notifications",
    "Automatiske varsler etter planlagt eller manuell synkronisering. Teams-innstillingene endres ikke.": "Automatic alerts after scheduled or manual synchronization. Teams settings are not changed.",
    "Spr\u00e5k i e-post": "Email language",
    "Norsk": "Norwegian",
    "Mottakere": "Recipients",
    "Maksimalt 20 adresser. Hver mottaker f\u00e5r sin egen e-post.": "Up to 20 addresses. Each recipient receives an individual email.",
    "+ Legg til mottaker": "+ Add recipient",
    "Legg bare til godkjente mottakere. Varslene inneholder kundenavn og opplysninger om elementet som utl\u00f8per.": "Add only approved recipients. Alerts contain the customer name and information about the expiring item.",
    "Varselniv\u00e5er": "Alert levels",
    "Samme action windows som Teams: grensene hentes fra hvert element, ikke fra en egen e-postplan.": "The same action windows as Teams: thresholds come from each item, not a separate email schedule.",
    "Sikker utsending": "Secure sending",
    "Brevo API-n\u00f8kkelen ligger kun som Worker secret. Avsender konfigureres sentralt. Testmail sendes til alle aktive, lagrede mottakere, ogs\u00e5 n\u00e5r automatisk varsling er av.": "The Brevo API key is stored only as a Worker secret. The sender is configured centrally. Test emails go to all saved active recipients, even when automatic notifications are off.",
    "Lagre og send testmail": "Save and send test email",
    "Lagre e-postvarsler": "Save email notifications",
    "E-post og Teams logges separat fra sikkerhetsloggen. Akseptert betyr at leverand\u00f8ren tok imot foresp\u00f8rselen, ikke bekreftet levering i innboksen eller kanalen.": "Email and Teams are logged separately from the security audit. Accepted means the provider accepted the request, not confirmed delivery to the inbox or channel.",
    "Kanal": "Channel",
    "Alle kanaler": "All channels",
    "E-post": "Email",
    "Alle statuser": "All statuses",
    "Akseptert": "Accepted",
    "Feilet": "Failed",
    "Usikker status": "Uncertain status",
    "Nytt fors\u00f8k planlagt": "Retry queued",
    "Vis flere": "Load more",
